...
},{"_css_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/incomes.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/expenses.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"src/hepler.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.calculateMoney = exports.calculateId = void 0;
...
},{}],"src/budget.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Budget, [{
    ...
    value: function addItem(type, description, value) {
      ...
      if (type === "inc") {
        item = new _incomes.default((0, _hepler.calculateId)(this.incomes), description, value);
        this.incomes.push(item);
      } else if (type === "exp") {
        item = new _expenses.default((0, _hepler.calculateId)(this.expenses), description, value);
    ...
    value: function calculateBudget() {
      this.totalIncomes = (0, _hepler.calculateMoney)(this.incomes);
      this.totalExpenses = (0, _hepler.calculateMoney)(this.expenses);
...
var _default = Budget;
exports.default = _default;
},{"./incomes":"src/incomes.js","./expenses":"src/expenses.js","./hepler":"src/hepler.js"}],"src/View.js":[function(require,module,exports) {
"use strict";
...
function setMonthInHtml() {
  var asd = document.getElementById('displayMonth');
  asd.innerHTML = month();
}
...
var _default = app;
exports.default = _default;
},{"./budget":"src/budget.js","./View":"src/View.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
_app.default.init();
},{"../styles/styles.css":"styles/styles.css","./app":"src/app.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
